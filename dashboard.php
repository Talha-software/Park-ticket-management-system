...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        ...
                                        <p style="font-size: 40px;color: red"><?php echo $count_today_cvisitors?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        ...
                                        <p style="font-size: 40px;color: red"><?php if($count_Yest_visitors==''):
                                        echo "0"; else:
